...
int ipv4_route_lookup ( ipv4_route_t * route, ipv4_addr_t addr )
{
  ...
  ipv4_addr_t aux, aux_mask;
  
  memcpy (aux, route->subnet_addr, sizeof(route->subnet_addr));
  memcpy (aux_mask, route->subnet_mask, sizeof(route->subnet_mask));
  
  char aux_mask_buffer [IPv4_STR_MAX_LENGTH];
  
  unsigned int aux_int [IPv4_ADDR_SIZE];
  unsigned int addr_int [IPv4_ADDR_SIZE];
  unsigned int aux_mask_int [IPv4_ADDR_SIZE];
  
  ipv4_addr_str (aux_mask, aux_mask_buffer);
  
  int i;
  
  for (i=0; i<IPv4_ADDR_SIZE; i++){
    
    aux_int [i] = (unsigned int) aux [i];
    addr_int [i] = (unsigned int) addr [i];
    aux_mask_int [i] = (unsigned int) aux_mask [i];
    
  }
  
  unsigned int aux_buffer [IPv4_ADDR_SIZE];
  
  int flag = 0;
  
  for (i=0; i<IPv4_ADDR_SIZE; i++){
    
    addr_int [i] = addr_int [i] & aux_mask_int [i];
    
    aux_buffer [i] = aux_int [i] | addr_int [i];
   
    if (aux_buffer [i] != aux_int [i]) flag = 1;
  ...
  if (flag == 0) {
    ...
    if (strcmp (aux_mask_buffer, "255.255.255.255") == 0) prefix_length = 32;
    if (strcmp (aux_mask_buffer, "255.255.255.254") == 0) prefix_length = 31;
    if (strcmp (aux_mask_buffer, "255.255.255.252") == 0) prefix_length = 30;
    if (strcmp (aux_mask_buffer, "255.255.255.248") == 0) prefix_length = 29;
    if (strcmp (aux_mask_buffer, "255.255.255.240") == 0) prefix_length = 28;
    if (strcmp (aux_mask_buffer, "255.255.255.224") == 0) prefix_length = 27;
    if (strcmp (aux_mask_buffer, "255.255.255.192") == 0) prefix_length = 26;
    if (strcmp (aux_mask_buffer, "255.255.255.128") == 0) prefix_length = 25;
    if (strcmp (aux_mask_buffer, "255.255.255.0") == 0) prefix_length = 24;
    if (strcmp (aux_mask_buffer, "255.255.254.0") == 0) prefix_length = 23;
    if (strcmp (aux_mask_buffer, "255.255.252.0") == 0) prefix_length = 22;
    if (strcmp (aux_mask_buffer, "255.255.248.0") == 0) prefix_length = 21;
    if (strcmp (aux_mask_buffer, "255.255.240.0") == 0) prefix_length = 20;
    if (strcmp (aux_mask_buffer, "255.255.224.0") == 0) prefix_length = 19;
    if (strcmp (aux_mask_buffer, "255.255.192.0") == 0) prefix_length = 18;
    if (strcmp (aux_mask_buffer, "255.255.128.0") == 0) prefix_length = 17;
    if (strcmp (aux_mask_buffer, "255.255.0.0") == 0) prefix_length = 16; 
    if (strcmp (aux_mask_buffer, "255.254.0.0") == 0) prefix_length = 15;
    if (strcmp (aux_mask_buffer, "255.252.0.0") == 0) prefix_length = 14;
    if (strcmp (aux_mask_buffer, "255.248.0.0") == 0) prefix_length = 13;
    if (strcmp (aux_mask_buffer, "255.240.0.0") == 0) prefix_length = 12;
    if (strcmp (aux_mask_buffer, "255.224.0.0") == 0) prefix_length = 11;
    if (strcmp (aux_mask_buffer, "255.192.0.0") == 0) prefix_length = 10;
    if (strcmp (aux_mask_buffer, "255.128.0.0") == 0) prefix_length = 9;
    if (strcmp (aux_mask_buffer, "255.0.0.0") == 0) prefix_length = 8;
    if (strcmp (aux_mask_buffer, "254.0.0.0") == 0) prefix_length = 7;
    if (strcmp (aux_mask_buffer, "252.0.0.0") == 0) prefix_length = 6;
    if (strcmp (aux_mask_buffer, "248.0.0.0") == 0) prefix_length = 5;
    if (strcmp (aux_mask_buffer, "240.0.0.0") == 0) prefix_length = 4;
    if (strcmp (aux_mask_buffer, "224.0.0.0") == 0) prefix_length = 3;
    if (strcmp (aux_mask_buffer, "192.0.0.0") == 0) prefix_length = 2;
    if (strcmp (aux_mask_buffer, "128.0.0.0") == 0) prefix_length = 1;
    if (strcmp (aux_mask_buffer, "0.0.0.0") == 0) prefix_length = 0;
